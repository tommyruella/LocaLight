...
new_load = """    loadLUT(lutData) {
        ...
        // Don't call render([]) here, it resets layers in bypass. Rely on app.js triggering it.
    }"""
...
# 3. Update precision of sampler3D in fsOutputSource
old_shader_sampler = "uniform mediump sampler3D u_lut;"
new_shader_sampler = "uniform highp sampler3D u_lut;"
engine = engine.replace(old_shader_sampler, new_shader_sampler)
